...
# ============================================================================
# STEP 2: SCAN THE DATASET STRUCTURE
# ============================================================================
...
# ============================================================================
# STEP 3: AUDIO ANALYSIS FUNCTIONS
# ============================================================================
...
def plot_audio_distributions(audio_df):
    """Plot distributions of audio properties"""
...
def visualize_sample_audio(file_path, sentence_text):
    """Visualize a single audio file in detail"""
...
def compare_sa1_sa2(df):
    """Compare SA1 and SA2 sentences side by side"""
