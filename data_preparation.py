...
class TIMITDataPreparation:
    def __init__(self, timit_root):
        """
        Args:
            timit_root: Chemin vers le dossier TIMIT
        """
    ...
    def get_sa_files(self, split='train'):
        """
        Récupère tous les fichiers SA1 et SA2 (phrases de calibration)
        
        Returns:
            Liste de dictionnaires avec path audio, transcription, speaker_id
        """
        data = []
    ...
    def create_manifest(self, output_dir='../data/manifests'):
        """
        Crée des fichiers manifest (JSON/CSV) pour l'entraînement
        """
...
if __name__ == "__main__":
    # Chemin vers votre corpus TIMIT - FIXED PATH
